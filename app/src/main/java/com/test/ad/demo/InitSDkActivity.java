            ...
            public void onClick(View v) {
                ...
                if (!mHasInitSdk) {
                    ...
                    if (TextUtils.isEmpty(mPrivacyWebView.getUrl())) {
                        mPrivacyWebView.loadUrl("https://www.statisticslinks.com/");
                    }
        ...
        mCBPersonAd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    SDMSDK.getInstance().getSetting().setPersonalizedAdStatus(SDMAdConst.PERSONALIZED_STATE.ALLOW_STATUS);
                } else {
                    putSPString(InitSDkActivity.this, "ad_setting", "person_ad", "2");
                    mTVPersonAdDesc.setText("当前状态：关闭");
                    SDMSDK.getInstance().getSetting().setPersonalizedAdStatus(SDMAdConst.PERSONALIZED_STATE.LIMIT_STATUS);
                }
            }
        });
    }
